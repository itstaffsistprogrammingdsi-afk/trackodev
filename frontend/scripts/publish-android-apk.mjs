...
const downloadsPath = join(projectRoot, "public", "downloads");
const destinationPath = join(
  downloadsPath,
  buildType === "release" ? "tracko-latest.apk" : "tracko-latest-debug.apk",
);
const metadataPath = join(
  downloadsPath,
  buildType === "release" ? "tracko-latest.json" : "tracko-latest-debug.json",
);
