...
export default function PublicFormPage() {
  ...
  const [otherValues, setOtherValues] =
    useState<OtherValues>({});
          ...
          >
            ...
            {field.type === "date" && (
              <div className="relative">
                <Calendar className="absolute left-0 top-1/2 h-4 w-4 -translate-y-1/2 text-slate-400" />
