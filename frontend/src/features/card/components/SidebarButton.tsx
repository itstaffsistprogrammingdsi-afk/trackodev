...
export default function SidebarButton({
  ...
  return (
    <button
      ...
      className={`min-h-12 w-full rounded-xl border px-3 py-2.5 text-left transition active:scale-[0.98] ${
        active
    ...
    >
      ...
      {badge && (
        <div className="ml-6 mt-1 truncate text-[10px] font-medium text-slate-500 dark:text-slate-400">
          {badge}
        </div>
      )}
    </button>
