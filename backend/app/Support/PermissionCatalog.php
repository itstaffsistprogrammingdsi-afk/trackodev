...
final class PermissionCatalog
{
    public static function modules(): array
    {
        return [
            ...
            'form' => self::module('Form', 'Kelola form, field, respons, dan assignment respons.', [
                ...
                'form.share' => 'Salin dan bagikan link publik form',
            ...
            'my_work' => self::module('My Work', 'Akses produktivitas, aktivitas, ranking, attachment, dan export pribadi.', [
                ...
                'my_work.export.pdf' => 'Export laporan kerja sendiri ke PDF',
                'my_work.export.excel' => 'Export laporan kerja sendiri ke Excel',
            ]),
            ...
            'report' => self::module('Report & QC', 'Akses laporan, preview, export, dan verifikasi QC.', [
                ...
                'report.filters.view' => 'Lihat pilihan filter report',
                'report.users.view' => 'Lihat daftar user pada report',
                'report.cards.view' => 'Lihat card user pada report',
    ...
    public static function userPermissions(): array
    {
        return [
            ...
            'campaign.stats.view', 'campaign.progress.view', 'campaign.gantt.view',
            ...
            'my_work.export.pdf', 'my_work.export.excel',
